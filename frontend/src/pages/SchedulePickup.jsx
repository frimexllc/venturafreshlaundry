      ...
      <section className="py-12">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-6 md:p-8 shadow-lg border border-slate-100">
            ...
            {/* Contact Method */}
            <div className="mb-6">
              <Label className="font-semibold text-slate-900">Best way to contact you</Label>
            ...
            {/* Laundry Preferences */}
            <div className="mb-6">
              <h3 className="font-semibold text-slate-900 mb-3">Laundry Preferences (Optional)</h3>
              <Textarea 
                value={form.notes}
            ...
            {/* Service Type */}
            <div className="mb-6">
              <Label className="font-semibold text-slate-900">Type of service *</Label>
              <Select value={form.service_type} onValueChange={(v) => setForm({...form, service_type: v})} required>
                <SelectTrigger className="mt-2">
                  <SelectValue placeholder="Select an option" />
                </SelectTrigger>
                <SelectContent>
