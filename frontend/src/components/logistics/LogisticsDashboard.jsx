      ...
      try {
        ...
        if (response.ok) {
          ...
          setStats(prev => ({
            ...
            completedToday: data.orders_today || 0,
            totalDistance: data.total_miles || 0,
            pendingPickups: Math.floor((data.pending_orders || 0) / 2),
            pendingDeliveries: Math.ceil((data.pending_orders || 0) / 2),
          }));
        }
      } catch (err) {
        ...
        <div className="flex-1 overflow-hidden flex flex-col">
          <Tabs defaultValue="overview" className="flex-1 flex flex-col overflow-hidden">
            ...
            <ScrollArea className="flex-1">
              <TabsContent value="overview" className="p-8 pt-6 pb-8">
                {/* Stats Grid */}
