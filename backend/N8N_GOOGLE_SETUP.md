...
2. O configura Zapier/Make para enviar a:
   ```
   https://pos-laundry-sys.preview.emergentagent.com/api/automation/ingest
   ```
...
curl -X POST https://pos-laundry-sys.preview.emergentagent.com/api/automation/ingest \
...
curl https://pos-laundry-sys.preview.emergentagent.com/api/automation/daily-summary

# Test de SLA alerts
curl https://pos-laundry-sys.preview.emergentagent.com/api/automation/sla-alerts
```
