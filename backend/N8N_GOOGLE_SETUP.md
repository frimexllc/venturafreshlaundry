...
2. O configura Zapier/Make para enviar a:
   ```
   https://laundry-forms-ux.preview.emergentagent.com/api/automation/ingest
   ```
...
curl -X POST https://laundry-forms-ux.preview.emergentagent.com/api/automation/ingest \
...
curl https://laundry-forms-ux.preview.emergentagent.com/api/automation/daily-summary

# Test de SLA alerts
curl https://laundry-forms-ux.preview.emergentagent.com/api/automation/sla-alerts
```
