...
2. O configura Zapier/Make para enviar a:
   ```
   https://ventura-deploy-test.preview.emergentagent.com/api/automation/ingest
   ```
...
curl -X POST https://ventura-deploy-test.preview.emergentagent.com/api/automation/ingest \
...
curl https://ventura-deploy-test.preview.emergentagent.com/api/automation/daily-summary

# Test de SLA alerts
curl https://ventura-deploy-test.preview.emergentagent.com/api/automation/sla-alerts
```
