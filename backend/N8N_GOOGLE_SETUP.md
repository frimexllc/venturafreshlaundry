...
2. O configura Zapier/Make para enviar a:
   ```
   https://laundry-portal-5.preview.emergentagent.com/api/automation/ingest
   ```
...
curl -X POST https://laundry-portal-5.preview.emergentagent.com/api/automation/ingest \
...
curl https://laundry-portal-5.preview.emergentagent.com/api/automation/daily-summary

# Test de SLA alerts
curl https://laundry-portal-5.preview.emergentagent.com/api/automation/sla-alerts
```
